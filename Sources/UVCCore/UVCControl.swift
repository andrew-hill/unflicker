...
public enum UVCControlError: Error, Equatable {
...
public struct UVCControl: Hashable, Sendable {
    ...
    public func parse(_ text: String) throws -> Int {
    ...
    public func format(_ raw: Int) -> String {
...
extension UVCControl {
    ...
    public static func named(_ name: String) -> UVCControl? {
